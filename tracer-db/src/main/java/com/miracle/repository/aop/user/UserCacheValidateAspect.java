...
import com.miracle.repository.utils.RedisKeyUtils;
...
public class UserCacheValidateAspect {
    ...
    @Pointcut("userDaoPoint() && @annotation(com.miracle.repository.cache.annotation.WriteAction)")
    public void writeActionPoint() { }

    @Pointcut("userDaoPoint() && @annotation(com.miracle.repository.cache.annotation.ReadAction)")
